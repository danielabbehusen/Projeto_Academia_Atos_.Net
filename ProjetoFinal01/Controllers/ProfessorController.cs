...
namespace ProjetoFinal01.Controllers
{
    public class ProfessorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idProfessor,Nome,CREF")] Professor professor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idProfessor,Nome,CREF")] Professor professor)
        {
